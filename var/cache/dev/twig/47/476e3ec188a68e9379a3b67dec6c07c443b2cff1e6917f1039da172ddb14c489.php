...
class __TwigTemplate_9c727d377894cdc6c5e38760fc5d86e741b9e70f874c27c9495e11cc2b20a884 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  122 => 19,  118 => 18,  115 => 17,  105 => 16,  94 => 22,  92 => 16,  88 => 14,  83 => 12,  80 => 11,  78 => 10,  69 => 3,  59 => 2,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"titreMainPage\">
        ...
        {% if is_granted('ROLE_USER') %}
            <br>
            <h4>Re-bonjour {{ app.user.username }} !</h4>
        {% endif %}
    </div>
    <div id=\"sidebar\">
        {% block sidebar %}
            <ul>
                <li><a href=\"{{ path('app_searchLivre') }}\">Recherches les livres</a></li>
                <li><a href=\"{{ path('app_recherche') }}\">Recherches le stock</a></li>
            </ul>
        {% endblock %}
    </div>
{% endblock %}
", "search/index.html.twig", "C:\\wamp64\\www\\bookcatalogue\\templates\\search\\index.html.twig");
    }
}
