...
class __TwigTemplate_b6eae513685d0ee4d6d4066bea61cfde85a75026a8994bcb8cfe392caf69ab9a extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        <tr>
            ...
            <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 16, $this->source); })()), "nomCategorie", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
        </tr>
        </tbody>
    </table>
...
{% endblock %}", "categorie/show.html.twig", "C:\\wamp64\\www\\bookcatalogue\\templates\\categorie\\show.html.twig");
    }
}
